...
var _Interface = require("./database/Interface");
  ...
  _createClass(EventSource, [{
    ...
    value: function customizer(objValue, srcValue, key) {
      ...
      if ((0, _isObject.default)(objValue) && (0, _isObject.default)(srcValue)) {
        ...
        var obj = (0, _mergeWith.default)(objValue, srcValue, this.customizer);
        return obj;
      }
    ...
    value: function reducer(acc, cur) {
      var obj = (0, _mergeWith.default)({}, cur, acc, this.customizer.bind(this));
      return obj;
    }
  }, {
    key: "getState",
      ...
      return this.db.getSnapshot(context).then(function (snapshot) {
        return _this.db.getEvents(context, snapshot.seq).then(function (events) {
          ...
          if (createSnapshot && state) {
            state.seq = (0, _last.default)(events).seq; // create a snapshot every time for increased efficiency
